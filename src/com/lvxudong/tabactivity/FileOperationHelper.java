...
public class FileOperationHelper {
    ...
    private ArrayList<FileItem> mCurFileNameList = new ArrayList<FileItem>();
    ...
    public void Copy(ArrayList<FileItem> files) {
        copyFileList(files);
    }
    ...
    public boolean Paste(String path) {
        ...
        asnycExecute(new Runnable() {
            @Override
            public void run() {
                for (FileItem f : mCurFileNameList) {
                    CopyFile(f, _path);
                }
    ...
    public void StartMove(ArrayList<FileItem> files) {
        if (mMoving)
            return;
    ...
    public boolean Rename(FileItem f, String newName) {
    ...
    public boolean Delete(ArrayList<FileItem> files) {
        copyFileList(files);
        asnycExecute(new Runnable() {
            @Override
            public void run() {
    ...
    protected void DeleteFile(FileItem f) {
        if (f == null) {
    ...
    private void CopyFile(FileItem f, String dest) {
        if (f == null || dest == null) {
    ...
    private boolean MoveFile(FileItem f, String dest) {
    ...
    private void copyFileList(ArrayList<FileItem> files) {
        synchronized(mCurFileNameList) {
            mCurFileNameList.clear();
